...
class CCGAN():
    def __init__(self):
        ...
        self.mask_height = 10 #縦
        self.mask_width = 10  #横
        self.num_classes = 10 #数字の数
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        X_train = np.array([np.array(PIL.Image.fromarray(x).resize((self.img_rows, self.img_cols))) for x in X_train])
